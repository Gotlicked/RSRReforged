package net.gotlicked.rsrreforged.craftingemitter;
...
public class CraftingEmitterContainerMenu extends AbstractResourceContainerMenu implements ExportingIndicatorListener {
    ...
    public CraftingEmitterContainerMenu(
        ...
        super(Menus.INSTANCE.getCraftingEmitter(), syncId, player);
    ...
    public CraftingEmitterContainerMenu(
        ...
        super(Menus.INSTANCE.getCraftingEmitter(), syncId);
