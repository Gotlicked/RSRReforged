...
public class CraftingEmitterScreen extends AbstractFilterScreen<CraftingEmitterContainerMenu> {
    public CraftingEmitterScreen(final CraftingEmitterContainerMenu menu, final Inventory playerInventory,
