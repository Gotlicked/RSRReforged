...
public class RequesterContainerMenu extends AbstractResourceContainerMenu implements ExportingIndicatorListener {
    ...
    public RequesterContainerMenu(
        ...
        super(Menus.INSTANCE.getRequester(), syncId, player);
    ...
    public RequesterContainerMenu(final int syncId, final Inventory playerInventory, final RequesterData interfaceData) {
        super(Menus.INSTANCE.getRequester(), syncId);
